...
class Cov
{
    public:
        ...
        void getWeightCov(GLMmodel *meshmodel);
        //	void Denoising(GLMmodel *meshmodel);
        void Denoising(GLMmodel *meshmodel,double **verNormal);

        void Deletes(IndexList **pverOfNeighborVer, IndexList **pverOfNeighborVern, IndexList **ptrianglesOfNeighborVer, double **pweightCov, int pn);
};
